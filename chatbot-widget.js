...
function startConversation() {
    fetch('https://chatbot-for-the-apple-tree-preschool.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
  ...
  //  sendInputToGAS3(userMessage, true);
    ...
    fetch('https://chatbot-for-the-apple-tree-preschool.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbxt6uMoOtxkXmkbJC4UikBTAkTPqPX1wBRmtQBu9KobDv9RAq2vbPVsTcZeo_siJqWJdQ/exec';
